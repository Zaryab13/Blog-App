...
const SignUpForm = () => {
  ...
  return (
    <>
      <form className="flex flex-col gap-5 py-4" onSubmit={formSubmitHandler}>
        <Input
          label="Your Username"
          inputType="text"
          hasError={usernameHasError}
      ...
      {errorMessage && (
        <p className="mt-4 p-4 absolute capitalize rounded-lg w-full text-red-800 bg-red-200 font-semibold">
          {errorMessage}
        </p>
      )}
    </>
